...
PRED_FILE = ROOT / "outputs" / "pred" / "pred_fake_sample20.json"
IMAGES_DIR = ROOT / "outputs" / "images"
VIS_DIR = ROOT / "outputs" / "vis"
...
def main() -> None:
    ...
    coco_gt = load_json(GT_FILE)
    pred_list = load_json(PRED_FILE)
    ...
    print(f"[OK] visualized {num_done} images to: {VIS_DIR}")
